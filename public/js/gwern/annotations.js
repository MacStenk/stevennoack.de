Annotations = {
	...
	_annotationIndex: (typeof window !== "undefined" && window.__annotationIndex) || null,
	_indexLoaded: false,
	_resolveFilename: (key) => {
		if (Annotations._annotationIndex && Annotations._annotationIndex[key]) {
			return Annotations._annotationIndex[key];
		}
...
Annotations = { ...Annotations,
	...
	sourceURLForLink: (link) => {
		return URLFromString(  Annotations.basePathname
							 + Annotations._resolveFilename(Annotations.targetIdentifier(link))
							 + ".html");
	},
